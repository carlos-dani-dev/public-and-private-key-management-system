...
def rsa_keypair_generation(bits_key_length, privatekey_file_password, publickey_filename, privatekey_filename):
    ...
    privatekey = iekey.export_RSA_privatekey("private/"+privatekey_filename + '.pem', key, privatekey_file_password)
    publickey = key.publickey()
    iekey.export_RSA_publickey("public/"+publickey_filename + '.pem', publickey)
